...
export const metadata: Metadata = {
  title: "Trending Videos – Top Free HD Porn This Week",
  description:
    "Watch the hottest trending free HD porn videos right now. Updated hourly – browse top weekly picks, most-viewed, and newest uploads across all major adult platforms.",
  keywords: [
  ...
  openGraph: {
    title: "Trending Videos – Top Free HD Porn This Week",
    description:
      "Watch the hottest trending free HD porn videos right now. Updated hourly.",
    url: "/trending",
  },
}
...
export default async function TrendingPage({ searchParams }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <VideoGrid key={`trending-${page}-${order}`} videos={data.videos} />
